...
public class IceClient 
{
	public static void main(String[] args) 
	{
		...
		try {
			...
			ObjectPrx base1 = communicator.stringToProxy("calc/calc11:tcp -h 127.0.0.2 -p 10000 -z : udp -h 127.0.0.2 -p 10000 -z"); //opcja -z w³¹za **mo¿liwoœæ** kompresji

			ObjectPrx base3 = communicator.stringToProxy("calc/calc33:tcp -h 127.0.0.2 -p 10000 -z : udp -h 127.0.0.2 -p 10000 -z"); //opcja -z w³¹za **mo¿liwoœæ** kompresji
			...
			// 4. Wywo³anie zdalnych operacji i zmiana trybu proxy dla zmiennej obj1
			do	{
				try	{
					System.out.println("==> ");
					line = in.readLine();
					...
					else if (line.equals("subtract"))
					{
						...
						System.out.println("RESULT = " + r);
						System.out.println(obj3.subtract(7, 8));
					}
